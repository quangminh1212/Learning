...
\centering
\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{sequence_ghi_nhan_hang_loi.png}
\captionof{figure}{Sequence Diagram: Ghi nhận hàng lỗi}
\end{landscape}

\begin{landscape}
\subsection{Sequence Diagram: Xử lý hàng lỗi}
\centering
\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{sequence_xu_ly_hang_loi.png}
\captionof{figure}{Sequence Diagram: Xử lý hàng lỗi}
\end{landscape}

\begin{landscape}
\subsection{Sequence Diagram: Thêm nhà cung cấp}
\centering
\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{sequence_them_nha_cung_cap.png}
\captionof{figure}{Sequence Diagram: Thêm nhà cung cấp}
\end{landscape}

\begin{landscape}
\subsection{Sequence Diagram: Tìm kiếm nhà cung cấp}
\centering
\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{sequence_tim_kiem_nha_cung_cap.png}
\captionof{figure}{Sequence Diagram: Tìm kiếm nhà cung cấp}
\end{landscape}

\begin{landscape}
\subsection{Sequence Diagram: Thêm kho}
\centering
\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{sequence_them_kho.png}
\captionof{figure}{Sequence Diagram: Thêm kho}
\end{landscape}

\begin{landscape}
\subsection{Sequence Diagram: Quản lý trạng thái kho}
\centering
\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{sequence_quan_ly_trang_thai_kho.png}
\captionof{figure}{Sequence Diagram: Quản lý trạng thái kho}
\end{landscape}
