...
def add_list_of_figures(doc):
    """Thêm danh sách hình vẽ vào tài liệu Word"""
    # Thêm tiêu đề "DANH SÁCH HÌNH VẼ"
    lof_heading = doc.add_paragraph("DANH SÁCH HÌNH VẼ", style="Heading 1")
    lof_heading.alignment = WD_ALIGN_PARAGRAPH.CENTER
    
    # Tạo paragraph cho LOF
...
def create_manual_toc_lof():
    """Tạo mục lục và danh sách hình vẽ thủ công vì field code không hoạt động tốt với python-docx"""
