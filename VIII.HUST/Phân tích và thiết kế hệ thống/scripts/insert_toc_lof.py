...
output_file = r"C:\Dev\Learning\VIII.HUST\Phân tích và thiết kế hệ thống\BaoCao\BaoCao_QuanLyKho_Final.docx"
...
# Copy toàn bộ nội dung từ file gốc (bao gồm cả hình ảnh)
# Sử dụng ElementTree để copy toàn bộ nội dung
...
print(f"Created complete document with TOC, LOF and full content: {output_file}")