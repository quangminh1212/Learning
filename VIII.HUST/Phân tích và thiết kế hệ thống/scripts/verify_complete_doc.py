...
def verify_complete_document():
    doc_path = r'C:\Dev\Learning\VIII.HUST\Phân tích và thiết kế hệ thống\request\Bai Tap Lon\Nhóm 3\Nhóm 3_BAO_CAO_HOAN_CHINH.docx'
    ...
    important_sections = {
        ...
        'PHAN 1 TONG QUAN': 'PHAN 1' in full_text.upper() or 'PHẦN 1' in full_text,
        'PHAN 2 PHAN TICH YEU CAU': 'PHAN 2' in full_text.upper() or 'PHẦN 2' in full_text,
        'PHAN 3 THIET KE HE THONG': 'PHAN 3' in full_text.upper() or 'PHẦN 3' in full_text,
        ...
        'HE THONG QUAN LY DU HOC SINH': 'DU HOC SINH' in full_text.upper() or 'DU HỌC SINH' in full_text,
    }
    
    with open(r'C:\Dev\Learning\complete_doc_verification.txt', 'w', encoding='utf-8') as f:
        f.write('COMPLETE DOCUMENT VERIFICATION\n')
        f.write('================================\n\n')
        ...
        f.write('\nCONTENT SAMPLE (First 30 lines):\n')
        for i, line in enumerate(text_content[:30]):
            if line.strip():
                f.write(f'{i+1}: {line[:80]}\n')
    
    print('Verification completed!')
    print('Results saved to complete_doc_verification.txt')
