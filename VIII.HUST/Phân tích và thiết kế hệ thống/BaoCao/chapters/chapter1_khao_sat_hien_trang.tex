...
Báo cáo theo \textbf{phân tích và thiết kế hướng đối tượng} (UML):

\begin{enumerate}[leftmargin=1.5cm]
    \item Nghiệp vụ $\rightarrow$ \textbf{Use Case} (tổng quát, phân rã, đặc tả).
    \item \textbf{Activity} (luồng bước của use case).
    \item \textbf{Sequence} (tương tác giữa các đối tượng).
    \item \textbf{Class} (lớp đối tượng và quan hệ).
    \item \textbf{State} / \textbf{Component} (bổ sung); thiết kế \textbf{bảng CSDL} + giao diện.
\end{enumerate}

Sơ đồ vẽ bằng TikZ / pgf-umlcd / pgf-umlsd trên LaTeX.

\section{Kết luận chương}

Chương 1: bối cảnh, phạm vi, yêu cầu; \textbf{hướng đối tượng}. Tiếp: Nghiệp vụ $\rightarrow$ UC $\rightarrow$ Activity $\rightarrow$ Sequence $\rightarrow$ Class $\rightarrow$ CSDL/UI.
