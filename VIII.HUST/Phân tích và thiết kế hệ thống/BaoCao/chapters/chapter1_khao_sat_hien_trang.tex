...
\begin{itemize}[leftmargin=1.5cm]
    ...
    \item Quản lý thông tin nhà cung cấp và danh mục hàng/kho.
...
\begin{itemize}[leftmargin=1.5cm]
    ...
    \item Hỗ trợ quản lý nhiều kho, nhiều loại hàng hóa và nhiều nhà cung cấp.
...
\begin{itemize}[leftmargin=1.5cm]
    ...
    \item Quản lý nhà cung cấp, hàng hóa, kho: thêm, sửa, xóa, tìm kiếm, xem danh sách.
...
\begin{itemize}[leftmargin=1.5cm]
    ...
    \item \textbf{Xuất danh sách}: pandas/openpyxl (Excel) khi cần.
\end{itemize}

\subsection{Hướng phân tích -- thiết kế: hướng đối tượng (OO)}

Tên chương theo \textbf{mục tiêu phân tích}, không đặt theo ``tên loại hình vẽ''. Mỗi giai đoạn \textbf{dùng} một biểu đồ phù hợp:

\begin{longtable}{|p{4.2cm}|p{5.5cm}|p{3.5cm}|}
\hline
\textbf{Giai đoạn (tên chương)} & \textbf{Dùng biểu đồ để phân tích} & \textbf{Chương} \\
\hline
\endfirsthead
\hline
\textbf{Giai đoạn (tên chương)} & \textbf{Dùng biểu đồ để phân tích} & \textbf{Chương} \\
\hline
\endhead
Phân tích chức năng & Use Case (tổng quát, phân rã, đặc tả) & Ch.3 \\
\hline
Phân tích cấu trúc & Class (lớp tổng thể + theo UC) & Ch.4 \\
\hline
Phân tích hành vi & Sequence (trình tự) + State & Ch.5 \\
\hline
\end{longtable}

Trước: khảo sát (Ch.1), nghiệp vụ + activity (Ch.2). Sau: thiết kế chi tiết (Ch.6), CSDL + giao diện (Ch.7).

\section{Kết luận chương}

Chương 1: bối cảnh, phạm vi, yêu cầu. Khung phân tích: \textbf{chức năng $\rightarrow$ cấu trúc $\rightarrow$ hành vi}.
