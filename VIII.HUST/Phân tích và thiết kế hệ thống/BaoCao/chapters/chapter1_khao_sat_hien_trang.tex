...
\begin{itemize}[leftmargin=1.5cm]
    ...
    \item Quản lý đơn đặt hàng và theo dõi thanh toán, công nợ.
    \item Cung cấp báo cáo thống kê nhập -- xuất -- tồn, cảnh báo tồn kho, báo cáo doanh thu.
...
\begin{itemize}[leftmargin=1.5cm]
    ...
    \item \textbf{Quản lý kho}: Giám sát tồn kho, phê duyệt phiếu nhập/xuất, xem báo cáo.
    \item \textbf{Nhân viên kho}: Thực hiện nhập kho, xuất kho, kiểm kê, cập nhật tồn kho.
    \item \textbf{Khách hàng}: Tra cứu đơn hàng và lịch sử giao dịch (nếu được cấp quyền).
    \item \textbf{Nhà cung cấp}: Cung cấp thông tin đơn hàng, theo dõi trạng thái nhập kho.
\end{itemize}
...
\begin{itemize}[leftmargin=1.5cm]
    ...
    \item Tạo báo cáo thống kê đa dạng về nhập xuất tồn, hàng hóa bán chạy, hàng tồn lâu ngày, giá trị tồn kho.
...
\begin{itemize}[leftmargin=1.5cm]
    ...
    \item Quản lý đơn đặt hàng: tạo, duyệt, theo dõi đơn hàng.
    \item Quản lý thanh toán: ghi nhận thanh toán, theo dõi công nợ.
    \item Kiểm kê tồn kho: đối chiếu thực tế với sổ sách, điều chỉnh chênh lệch.
    \item Báo cáo thống kê: xuất báo cáo nhập xuất tồn, tồn kho thấp, hàng bán chạy, công nợ.
\end{itemize}
