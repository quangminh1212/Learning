...
Phân tích theo \textbf{3 giai đoạn} (mỗi giai đoạn một loại biểu đồ chính):
...
\hline
2. Phân tích cấu trúc & Class (lớp) & Ch.4 \\
\hline
3. Phân tích hành vi & Sequence (trình tự) & Ch.5 \\
\hline
\end{longtable}

Trước phân tích: khảo sát (Ch.1), mô tả nghiệp vụ + activity (Ch.2). Sau phân tích: thiết kế chi tiết (Ch.6), CSDL + giao diện (Ch.7).

\section{Kết luận chương}

Chương 1: bối cảnh, phạm vi, yêu cầu. Khung 3 giai đoạn phân tích: \textbf{chức năng -- cấu trúc -- hành vi} (Use Case -- Class -- Sequence).
