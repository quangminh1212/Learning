...
Component Diagram mô tả các thành phần phần mềm chính của hệ thống và mối quan hệ giữa chúng. Hệ thống được tổ chức theo kiến trúc phân lớp gồm: giao diện người dùng, controller, service, repository và cơ sở dữ liệu. Các dịch vụ chuyên biệt như xác thực, báo cáo và quản lý tồn kho được tách riêng để dễ bảo trì và mở rộng.

\input{diagrams/component}

\section{Kết luận chương}

Chương 6 đã mô tả chi tiết các lớp trong hệ thống, các quan hệ giữa chúng và thiết kế thành phần phần mềm. Các thiết kế này là nền tảng để xây dựng mô hình cơ sở dữ liệu và triển khai phần mềm trong Chương 7.
