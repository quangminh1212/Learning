...
\begin{class}[text width=5cm]{NhomHangHoa}{-7.5,3}
\attribute{+ MaNhomHang: String}
\attribute{+ TenNhomHang: String}
\attribute{+ MoTa: String}
\end{class}

\begin{class}[text width=5cm]{HangHoa}{-2.5,3}
...
\begin{class}[text width=5cm]{DonViTinh}{2.5,3}
\attribute{+ MaDonViTinh: String}
\attribute{+ TenDonViTinh: String}
\end{class}

\begin{class}[text width=5cm]{Kho}{-7.5,-1}
...
\begin{class}[text width=5cm]{NguoiDung}{-2.5,-1}
...
\begin{class}[text width=5cm]{NhaCungCap}{2.5,-1}
...
\begin{class}[text width=5cm]{KhachHang}{-7.5,-5}
...
\begin{class}[text width=5cm]{TonKho}{-2.5,-5}
\attribute{+ MaKho: String}
\attribute{+ MaHangHoa: String}
