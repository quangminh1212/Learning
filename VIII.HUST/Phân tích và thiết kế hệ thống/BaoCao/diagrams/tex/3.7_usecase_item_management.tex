...
\node[actor, label=below:{\scriptsize\bfseries Nhân viên kho}] (nv) at (-7.5,0.8) {};
\node[actor, label=below:{\scriptsize\bfseries Quản lý kho}] (ql) at (7.5,0.8) {};
% Hàng: NV + QL; Kho: chỉ QL (QTV không quản lý kho)
