...
% QTV chỉ quản lý tài khoản (+ đăng nhập/đăng xuất)
\draw (admin) -- (g1); \draw (admin) -- (g2);
% QL: nghiệp vụ kho (không quản lý tài khoản)
\draw (qlk) -- (g1); \draw (qlk) -- (g3); \draw (qlk) -- (g5); \draw (qlk) -- (g6);
\draw (qlk) -- (g7); \draw (qlk) -- (g8); \draw (qlk) -- (g9); \draw (qlk) -- (g10);
% NV: thao tác danh mục/phiếu (không kho master, không báo cáo, không TK)
