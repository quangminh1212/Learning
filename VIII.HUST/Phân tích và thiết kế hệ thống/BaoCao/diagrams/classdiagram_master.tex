...
\begin{class}[text width=3.5cm]{NhomHangHoa}{-6,3}
\attribute{+ MaNhomHang: String}
\attribute{+ TenNhomHang: String}
\attribute{+ MoTa: String}
\end{class}

\begin{class}[text width=3.5cm]{HangHoa}{-1,3}
...
\begin{class}[text width=3.5cm]{DonViTinh}{4,3}
\attribute{+ MaDonViTinh: String}
\attribute{+ TenDonViTinh: String}
\end{class}

\begin{class}[text width=3.5cm]{Kho}{-6,-1}
...
\begin{class}[text width=3.5cm]{NguoiDung}{-1,-1}
...
\begin{class}[text width=3.5cm]{NhaCungCap}{4,-1}
...
\begin{class}[text width=3.5cm]{KhachHang}{-6,-5}
...
\begin{class}[text width=3.5cm]{TonKho}{-1,-5}
\attribute{+ MaKho: String}
\attribute{+ MaHangHoa: String}
